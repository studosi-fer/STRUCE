...
x_validate = read_x('X_test.txt')
y_validate = read_y('y_test.txt')
...
nerr, e0, e = classify(x_validate,y_validate)
print 'greska na skupu za provjeru: %.2f%%' % ((float(nerr) / len(x_validate)) * 100,)
